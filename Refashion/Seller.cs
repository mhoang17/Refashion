...
namespace Refashion
{
    public class Seller
    {
        ...
        public Seller(int tag, string firstName, string lastName, string address, string city, int zip, int phonenumber)
        {
        ...
        public Seller(string firstName, string lastName, string address, string city, int zip, int phonenumber) {
